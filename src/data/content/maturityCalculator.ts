  ...
  classificationQuestions: [
    {
      ...
      options: [
        { text: 'Startup (1-10 employees)', score: 1, pathwayFilter: ['early'] },
        { text: 'Small business (11-50 employees)', score: 2, pathwayFilter: ['early', 'growing'] },
        { text: 'Medium business (51-250 employees)', score: 3, pathwayFilter: ['growing', 'medium'] },
        { text: 'Large company (251-1,000 employees)', score: 4, pathwayFilter: ['medium', 'advanced', 'enterprise'] },
        { text: 'Enterprise (1,000+ employees)', score: 5, pathwayFilter: ['advanced', 'enterprise'] },
      ],
    },
    {
      id: 'classification-2',
      category: 'Organization Profile',
      question: 'What best describes your organization\'s current analytics capabilities?',
      options: [
        { text: 'Limited or no analytics - mostly using spreadsheets and manual processes', score: 1, pathwayFilter: ['early'] },
        { text: 'Basic reporting and dashboards exist, but they are inconsistent or siloed across departments', score: 2, pathwayFilter: ['early', 'growing'] },
        { text: 'Regular reporting and dashboards are established, with some insights being used for decision-making', score: 3, pathwayFilter: ['growing', 'medium'] },
        { text: 'Advanced analytics with predictive models, and most major decisions include data analysis', score: 4, pathwayFilter: ['medium', 'advanced'] },
        { text: 'AI/ML in production, and data drives most business decisions across the organization', score: 5, pathwayFilter: ['advanced', 'enterprise'] },
      ],
    },
    {
      id: 'classification-3',
  ...
  questions: {
    ...
    core: [
      {
        ...
        options: [
          ...
          { text: 'Advanced data architecture (fabric or mesh) with intelligent automation, real-time streaming, and self-service capabilities', score: 5 },
        ],
      },
      {
        id: 'infra-2',
        ...
        options: [
          { text: 'Data is highly siloed and difficult to access, requiring IT support for most requests (typically takes days or weeks)', score: 1 },
          { text: 'Limited self-service access with significant IT involvement needed for data requests (typically takes days)', score: 2 },
          { text: 'Moderate self-service capabilities for specific departments or use cases (business users can access approved datasets)', score: 3 },
          { text: 'Broad self-service access across most of the organization with role-based permissions and data catalog', score: 4 },
          { text: 'Fully democratized data access with intelligent governance, cataloging, semantic layers, and seamless user experience', score: 5 },
        ],
      },
      {
        id: 'analytics-1',
        ...
        options: [
          { text: 'Primarily basic reporting using Excel and simple spreadsheets for historical data', score: 1 },
          { text: 'Descriptive analytics - reporting on what happened (historical analysis, dashboards, and basic visualizations)', score: 2 },
          { text: 'Diagnostic analytics - understanding why things happened (root cause analysis, drill-downs, and ad-hoc investigation)', score: 3 },
          { text: 'Predictive analytics - forecasting what will likely happen (statistical models, ML predictions, and trend analysis)', score: 4 },
          { text: 'Prescriptive analytics and AI-driven insights - automated recommendations, optimization, and what-if scenarios (advanced ML/AI)', score: 5 },
        ],
      },
      {
        id: 'people-1',
        ...
        options: [
          { text: 'Primarily basic Excel skills with limited analytical capabilities - no dedicated analytics roles', score: 1 },
          { text: 'Some SQL skills and reporting capabilities, mainly in IT or a small analytics team (1-3 people)', score: 2 },
          { text: 'Dedicated analytics team (4+ people) with BI tool expertise, basic data engineering skills, and some SQL/Python knowledge', score: 3 },
          { text: 'Data scientists, data engineers, and analytics professionals on staff with diverse skill sets (SQL, Python/R, ML, cloud platforms)', score: 4 },
          { text: 'Center of excellence with data engineers, scientists, analysts, and citizen data scientists across the organization - comprehensive skill coverage', score: 5 },
        ],
      },
      {
        id: 'culture-1',
        ...
        options: [
          { text: 'Primarily based on intuition, experience, and gut feeling - data is rarely consulted', score: 1 },
          { text: 'Mix of intuition and some data, but data is not consistently used or trusted - decisions often override data', score: 2 },
          { text: 'Data-informed decisions when data is available, but not consistently required or standardized across teams', score: 3 },
          { text: 'Data-driven approach for most major decisions with analytics as a key input - decisions require data justification', score: 4 },
          { text: 'Data is central to all decisions - from strategy to operations, with a culture of fact-based choices and data-first mindset', score: 5 },
        ],
      },
      {
        id: 'governance-1',
        ...
        options: [
          { text: 'No formal data privacy or security policies in place - ad-hoc or reactive approach', score: 1 },
          { text: 'Basic IT security measures (firewalls, antivirus) but no comprehensive data privacy framework or policies', score: 2 },
          { text: 'Formal data security policies in place with some privacy considerations, but not consistently enforced', score: 3 },
          { text: 'Compliance with major regulations (UAE PDPL, GDPR, etc.) with documented processes, regular audits, and data protection measures', score: 4 },
          { text: 'Comprehensive privacy and security framework with proactive risk management, continuous monitoring, incident response, and privacy-by-design principles', score: 5 },
        ],
      },
    ] as Question[],
    ...
    early: [
      {
        ...
        options: [
          { text: 'Frequent data inconsistencies and reliability issues, no systematic quality controls - quality problems discovered after the fact', score: 1 },
          { text: 'Some ad-hoc quality checks but ongoing data quality problems remain unresolved - reactive approach to quality issues', score: 2 },
          { text: 'Standardized quality processes for critical business data with periodic monitoring and defined quality metrics', score: 3 },
          { text: 'Automated data quality monitoring, validation rules, proactive alerting systems, and quality dashboards for key datasets', score: 4 },
          { text: 'Comprehensive data quality framework with SLAs, continuous monitoring, predictive quality management, and automated remediation', score: 5 },
        ],
      ...
      },
      {
        ...
        options: [
          { text: 'Manual reports created and distributed periodically via email or presentations - typically monthly or quarterly', score: 1 },
          { text: 'Static dashboards with limited interactivity, updated on a scheduled basis (daily or weekly)', score: 2 },
          { text: 'Interactive dashboards and BI tools that users can explore, refreshed regularly (daily or near-real-time)', score: 3 },
          { text: 'Real-time dashboards with automated alerts and proactive notifications for key metrics and anomalies', score: 4 },
          { text: 'AI-powered insights pushed proactively, personalized recommendations, intelligent alerting, and embedded analytics in business applications', score: 5 },
        ],
        requiredFor: ['early', 'growing'],
      },
      {
    ...
    growing: [
      ...
      },
      {
        ...
        options: [
          { text: 'Weeks or months - requires significant manual work, coordination across teams, and custom development', score: 1 },
          { text: '1-2 weeks - needs IT or analyst support to gather and analyze data, create custom reports', score: 2 },
          { text: 'A few days - most questions can be answered with existing reports, dashboards, or quick ad-hoc analysis', score: 3 },
          { text: 'Within a day - self-service tools enable rapid insights for most stakeholders without IT dependency', score: 4 },
          { text: 'Minutes to hours - true self-service analytics with real-time data access, intuitive tools, and pre-built analytical models', score: 5 },
        ],
        requiredFor: ['growing', 'medium'],
      },
      {
      ...
      },
      {
        ...
        options: [
          { text: 'Most employees avoid using data, prefer intuition or established processes - data is seen as complex or intimidating', score: 1 },
          { text: 'Only dedicated analysts or data professionals regularly use data tools - business users are not expected to use data', score: 2 },
          { text: 'Some departments and teams actively embrace data-driven approaches - others are still learning or resistant', score: 3 },
          { text: 'Data usage is widely accepted and encouraged across most of the organization - majority of employees use data in their work', score: 4 },
          { text: 'Everyone actively seeks data to inform their work, with high data literacy and enthusiasm - data fluency is a core competency', score: 5 },
        ],
        requiredFor: ['growing', 'medium'],
      },
    ] as Question[],
    ...
    advanced: [
      ...
      },
      {
        ...
        options: [
          { text: 'No real-time processing capabilities - all data processing is batch-based with delays of hours or days', score: 1 },
          { text: 'Some batch processing with periodic updates (hourly, daily) - no true real-time capabilities', score: 2 },
          { text: 'Hybrid approach with some near-real-time capabilities (minutes delay) for critical processes', score: 3 },
          { text: 'Real-time streaming for key business processes and use cases (seconds to minutes latency) with event processing', score: 4 },
          { text: 'Comprehensive real-time data platform with event-driven architecture across all systems - sub-second latency for critical processes', score: 5 },
        ],
      ...
      },
      {
        ...
        options: [
          { text: 'Not using machine learning or advanced analytics at all - only traditional reporting and analysis', score: 1 },
          { text: 'Exploring or planning to start ML projects, but nothing in production yet - still in research/evaluation phase', score: 2 },
          { text: 'Pilot ML projects in specific areas with some proof-of-concept models - limited production deployments', score: 3 },
          { text: 'Production ML models deployed in several business use cases (3+ use cases) with measurable impact and ROI tracking', score: 4 },
          { text: 'ML and AI deeply integrated across the organization, driving core business decisions and competitive advantage - multiple models in production across departments', score: 5 },
        ],
        requiredFor: ['medium', 'advanced', 'enterprise'],
      },
      {
      ...
      },
      {
        ...
        options: [
          { text: 'No systematic documentation or metadata management - knowledge exists only in people\'s heads or scattered files', score: 1 },
          { text: 'Documentation scattered in various locations (emails, wikis, documents) with no central system or version control', score: 2 },
          { text: 'Basic data dictionary or catalog for key systems and critical data - manually maintained with limited lineage', score: 3 },
          { text: 'Centralized metadata repository with searchable documentation and some automated lineage tracking for key systems', score: 4 },
          { text: 'Active data catalog with comprehensive metadata, automated lineage, data quality scores, business glossary, and self-service discovery', score: 5 },
        ],
        requiredFor: ['advanced', 'enterprise'],
        skipFor: ['early'],
      },
